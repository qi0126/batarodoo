odoo.define('report.batar_printer', function (require) {
...
var report_report = require('report.report')
...
//    report_report.ActionManager.include({
    ir_actions_report_xml: function(action, options) {
        ...
        if ('report_type' in action && (action.report_type == 'qweb-html' || action.report_type == 'qweb-pdf' || action.report_type == 'controller')) {
            ...
            if (action.report_type == 'qweb-html') {
                ...
                var LODOP; //声明为全局变量
        		LODOP=getLodop();
        		LODOP.ADD_PRINT_URL(0,0,"100%","100%", report_url);
        		LODOP.PRINT();
